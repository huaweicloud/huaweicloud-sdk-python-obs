...
"""
  This sample demonstrates how to put bucket public access block operation on OBS using the OBS SDK for Python.
"""
...
if __name__ == '__main__':
    ...
    try:
        # Configure PublicAccessBlock for the bucket.
