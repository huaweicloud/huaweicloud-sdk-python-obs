...
"""
  This sample demonstrates how to create a browser-based upload signature on OBS using the OBS SDK for Python.
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        expires = 3600
        # Specify parameters for a browser-based upload except key, policy, and signature
        ...
        print('Create Post Signature Failed')
