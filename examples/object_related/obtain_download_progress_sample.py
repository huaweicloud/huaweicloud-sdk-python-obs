...
"""
  This sample demonstrates how to get object with progress callback operation on OBS using the OBS SDK for Python.
"""
...
def callback(transferredAmount, totalAmount, totalSeconds):
    ...
    print(f"average download rate (KB/s): {transferredAmount * 1.0 / totalSeconds / 1024}")
    # Obtain the download progress in percentage.
    print(f"download progress in percentage: {transferredAmount * 100.0 / totalAmount} %")
