...
"""
  This sample demonstrates how to download file operation on OBS using the OBS SDK for Python.
"""
...
if __name__ == '__main__':
    try:
        ...
        resp = obsClient.downloadFile(bucketName, objectKey, downloadPath, partSize, taskNum, enableCheckpoint)
