...
class TestBucketInventory(object):
    ...
    def test_put_inventory_basic(self):
        ...
        try:
            ...
            # Verify: Get the inventory configuration to confirm it was set correctly
            get_resp = client.getBucketInventory(bucket_name, inventory_id)
            assert get_resp.status == 200
            assert get_resp.body.inventoryId == inventory_id
            assert get_resp.body.isEnabled is True
            assert get_resp.body.objectVersion == InventoryIncludedObjectVersions.All
            assert get_resp.body.frequency == InventoryFrequency.Daily
    ...
    def test_put_inventory_with_filter(self):
        ...
        try:
            ...
            assert get_resp.body.inventoryId == inventory_id
            assert get_resp.body.isEnabled is True
            assert get_resp.body.filter.prefix == 'test-prefix/'
    ...
    def test_put_inventory_with_optional_fields(self):
        ...
        try:
            ...
            config = InventoryConfiguration(
                ...
                destination=destination,
                filter=InventoryFilter(prefix='optional/')
            )
            ...
            assert get_resp.body.inventoryId == inventory_id
            assert get_resp.body.isEnabled is True
            assert get_resp.body.optionalFields is not None
            assert len(get_resp.body.optionalFields) == 3
    ...
    def test_put_inventory_with_dict(self):
        ...
        try:
            ...
            assert get_resp.body.inventoryId == inventory_id
            assert get_resp.body.isEnabled is True
            assert get_resp.body.filter.prefix == 'inventory2/'
    ...
    def test_list_inventory(self):
        ...
        try:
            ...
            config = InventoryConfiguration(
                ...
                frequency=InventoryFrequency.Daily,
                destination=destination,
                filter=InventoryFilter(prefix='list/')
            )
            resp = client.putBucketInventory(bucket_name, inventory_id, config)
            assert resp.status == 200
    ...
    def test_delete_inventory(self):
        ...
        try:
            ...
            config = InventoryConfiguration(
                ...
                frequency=InventoryFrequency.Daily,
                destination=destination,
                filter=InventoryFilter(prefix='delete/')
            )
            put_resp = client.putBucketInventory(bucket_name, inventory_id, config)
            assert put_resp.status == 200
            ...
            # Verify: Confirm the inventory configuration has been deleted
            get_resp = client.getBucketInventory(bucket_name, inventory_id)
    ...
    def test_update_inventory(self):
        ...
        try:
            ...
            config = InventoryConfiguration(
                ...
                frequency=InventoryFrequency.Daily,
                destination=destination,
                filter=InventoryFilter(prefix='initial/')
            )
            ...
            get_resp = client.getBucketInventory(bucket_name, inventory_id)
            assert get_resp.status == 200
            assert get_resp.body.isEnabled is False
            assert get_resp.body.objectVersion == InventoryIncludedObjectVersions.Current
            assert get_resp.body.frequency == InventoryFrequency.Weekly
    ...
    def test_inventory_disabled(self):
        ...
        try:
            ...
            config = InventoryConfiguration(
                ...
                frequency=InventoryFrequency.Daily,
                destination=destination,
                filter=InventoryFilter(prefix='disabled/')
            )
    ...
    def test_inventory_current_version_only(self):
        ...
        try:
            ...
            config = InventoryConfiguration(
                ...
                frequency=InventoryFrequency.Daily,
                destination=destination,
                filter=InventoryFilter(prefix='current/')
            )
    ...
    def test_inventory_weekly_frequency(self):
        ...
        try:
            ...
            config = InventoryConfiguration(
                ...
                frequency=InventoryFrequency.Weekly,
                destination=destination,
                filter=InventoryFilter(prefix='weekly/')
            )
